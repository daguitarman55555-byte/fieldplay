...
The upgraded wallpaper is a separate WebGL2 entry at `wallpaper.html`. It includes Field, Attractor, Nebula, Galaxy, and Black Hole scenes. The original FieldPlay editor remains available at `index.html`, and the Gate 0 diagnostic remains at `gate0.html`.
