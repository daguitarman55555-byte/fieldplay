...
const root=resolve(import.meta.dirname),out=resolve(root,'dist'),published=resolve(root,'published');await rm(out,{recursive:true,force:true});await mkdir(out,{recursive:true});
...
await rm(published,{recursive:true,force:true});await cp(out,published,{recursive:true});
