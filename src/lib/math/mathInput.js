const FUNCTION_NAMES=['arcsinh','arccosh','arctanh','smoothstep','arcsin','arccos','arctan','degrees','radians','log10','atan2','asinh','acosh','atanh','sinh','cosh','tanh','sqrt','cbrt','floor','ceil','round','trunc','fract','hypot','clamp','log2','logb','exp2','asin','acos','atan','sin','cos','tan','sec','csc','cot','abs','exp','log','ln','min','max','pow','mod','mix','lerp','step','sign','root'];
