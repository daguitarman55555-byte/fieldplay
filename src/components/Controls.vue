...
<path d="M10.812 7.242l-10.375 5.766q-0.18 0.102-0.309 0.023t-0.129-0.281v-11.5q0-0.203 0.129-0.281t0.309 0.023l10.375 5.766q0.18 0.102 0.18 0.242t-0.18 0.242z"></path>
    ...
    <a href='#' @click.prevent='toggleSettings' class='action'>{{(settingsPanel.collapsed ? "Show panel" : "Hide panel")}}</a>
    <a href='#' @click.prevent='generateNewFunction' title='Generate a random field'>Randomize</a>
    <a href='#' @click.prevent='resetView' title='Return viewport to origin'>Fit</a>
...
.controls {
  ...
  a:hover { background: #0d2038; color: #66c4ff; }
