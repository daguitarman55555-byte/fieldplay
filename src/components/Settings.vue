...
export default {
  ...
  methods: {
    ...
    toggleAdaptive(){if(this.adaptiveController){this.adaptiveController.dispose();this.adaptiveController=null;}if(this.adaptiveEnabled){const dpr=Math.min(devicePixelRatio||1,2),pixels=innerWidth*innerHeight*dpr*dpr,maxParticles=pixels>5000000?65000:100000;this.adaptiveController=createAdaptiveQuality({scene:this.scene,quality:'auto',maxParticles,onChange:count=>{this.particlesCount=count;}});}},
    ...
    onSceneReady(scene) {
      ...
      if(this.adaptiveEnabled)this.toggleAdaptive();
      this.updateBBox();
